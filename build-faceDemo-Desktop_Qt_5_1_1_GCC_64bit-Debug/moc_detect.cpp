...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Detect_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 111, 20)
    },
    "Detect\0on_recognize_clicked\0\0"
    "on_startCam_clicked\0on_changePerson_clicked\0"
    "on_takePic_clicked\0on_savePic_clicked\0"
    "on_trainData_clicked\0"
};
...
void Detect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_recognize_clicked(); break;
        case 1: _t->on_startCam_clicked(); break;
        case 2: _t->on_changePerson_clicked(); break;
        case 3: _t->on_takePic_clicked(); break;
        case 4: _t->on_savePic_clicked(); break;
        case 5: _t->on_trainData_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Detect::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Detect.data,
      qt_meta_data_Detect,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Detect.stringdata))
